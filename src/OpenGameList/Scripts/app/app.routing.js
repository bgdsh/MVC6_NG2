System.register(["@angular/router", "./home.component", "./about.component", "./item-detail.component", "./login.component", "./page-not-found.component"], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, home_component_1, about_component_1, item_detail_component_1, login_component_1, page_not_found_component_1;
