...
namespace OpenGameListWebApp.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        /// </summary>
        /// <returns>
        /// Nothing: this method will raise a HttpNotFound HTTP exception, 
        ...
        /// </summary>
        /// <returns>
        /// An array of a default number of Json-serialized objects representing the last inserted items.
        /// </returns>
        [HttpGet("GetLatest")]
        ...
        /// representing the items with most user views.
        /// </returns>
       [HttpGet("GetMostViewed")]
        ...
        /// </summary> 
        /// <returns>
        /// An array of {n} Json-serialized objects representing the items with most user views.
        /// </returns> 
        ...
        /// </summary>
        /// <returns>
        /// An array of a default number of Json-serialized objects representing some randomly-picked items.
        /// </returns>
        [HttpGet("GetRandom")]
        ...
        /// </summary> 
        /// <returns>
        /// An array of {n} Json-serialized objects representing some randomly-picked items.
        /// </returns> 
        [HttpGet("GetRandom/{n}")]
        ...
        /// that can be used to generate the JsonResult return value for this Controller's methods. 
        /// </summary> 
        ...
        /// <summary>
        /// Returns the default number of items to retrieve 
        /// when using the parameterless overloads of the API methods retrieving item lists.
        /// </summary>
        ...
        /// to retrieve when using the API methods retrieving item lists.
        /// </summary>
